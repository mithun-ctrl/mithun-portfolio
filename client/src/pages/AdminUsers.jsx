...
const ADMIN_USERS_URL = "https://mithun-portfolio-production.up.railway.app/api/admin/users";
...
export const AdminUsers = () => {
    ...
    const deleteUser = async (id) =>{
        const DELETE_USERS_URL = `https://mithun-portfolio-production.up.railway.app/api/admin/users/delete/${id}`;
